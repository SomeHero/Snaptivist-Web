...
module Hipchat
  ...
  def self.perform(petition, signature)
    ...
    message = user.first_name + " " + user.last_name + " (" + user.email + ") just signed the petition " + petition["title"] + ".  The petition has been signed " + petition["signatures_count"] + " times."
