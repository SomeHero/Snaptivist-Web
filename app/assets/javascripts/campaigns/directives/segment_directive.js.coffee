@app.directive 'ngSegment', ['$http', '$templateCache', '$compile', '$timeout', '$window', '$sce', 'CampaignServices', ($http, $templateCache, $compile, $timeout, $window, $sce, CampaignServices) ->
  getTemplate = (layout, contentType) ->
    ...
    templateMap = {
      ...
      donation_action: 'donation-action.html',
