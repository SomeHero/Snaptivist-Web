@PetitionSignaturesController = ($scope, $route, $modal, $log, $rootScope, $location, $routeParams, $q, signatures, PetitionServices) ->
	...
	$scope.change_page = (page) ->
		...
		PetitionServices.get_signatures(petition_id, offset).then (response) ->
...
PetitionSignaturesController.resolve =
