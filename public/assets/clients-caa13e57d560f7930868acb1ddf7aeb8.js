...
(function() {
  ...
  this.ClientsController = function($scope, $rootScope, ClientFactory, Util) {
    ...
    $scope.update_page_list = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        page = _ref[_i];
        _results.push($scope.page_list.push({
          title: page.name,
    ...
    $scope.update_stylesheet_list = function() {
      ...
      return $scope.stylesheet_list.push({
        href: '/assets/themes/' + $scope.settings.layout + '_' + $scope.settings.theme + '.css'
      });
    };
    $scope.new_petition_clicked = function() {
...
(function() {
  ...
  this.PetitionSetupController = function($scope, $route, $modal, $log, $rootScope, $location, fileReader, ClientFactory, PetitionServices, Util, layouts) {
    var lastRoute, tag, _i, _len, _ref;
    window.scope = $scope;
    ...
    if ($scope.petition.action_tags) {
      _ref = $scope.petition.action_tags.split(',');
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        tag = _ref[_i];
    ...
    $scope.goto_step_clicked = function(step) {
