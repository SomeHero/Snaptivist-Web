(function() {
  ...
  this.app = angular.module('petition', ['ui.bootstrap.tpls', 'ui.bootstrap', 'custom.bootstrap']);
    ...
    return {
      ...
      controller: function($scope, $attrs) {
        ...
        fetch = function() {
          ...
          return $scope.sign_with_facebook($scope.auth);
        };
        (function(d) {
          var id, js, ref;
          js = void 0;
...
(function() {
  ...
  this.DeliveryController = function($scope, PetitionServices, PetitionFactory, $http, $q, Util, $rootScope, $interpolate, $timeout) {
    var remove_errors;
    ...
    $scope.deliver_action = function(form) {
          ...
          if (twitter_window.closed) {
            ...
            return $scope.$apply(function() {
              return PetitionServices.check_twitter_connect().then(function(response) {
                return PetitionServices.deliver_signature($scope.petition.petition_id, $scope.signature.signature_id, $scope.tweet.message).success(function(response) {
    ...
    $scope.get_tweet_message_length = function() {
      if ($scope.tweet.message) {
        return $scope.tweet.message.length;
      } else {
        return 0;
      }
    };
    remove_errors = function() {
      return $scope.error_messages.deliver_tweet = "";
    };
    $scope.clear_errors = function() {
      return $timeout(remove_errors, 4000);
    };
    $scope.get_number_of_tweets = function() {
      return $scope.tweets.total;
    };
    return $scope.calculate_petition_tweet_percentage = function() {
      return $scope.tweets.total / $scope.petition.target_count * 100;
    };
  };
...
(function() {
  ...
  this.PetitionController = function($scope, PetitionServices, $http, Util, PetitionFactory, $rootScope, $interpolate) {
    ...
    $scope.change_page = function() {
      ...
      if (page.url_redirect) {
        return Util.navigate_absolute($scope.petition[page.url_redirect_property], "", false);
      } else {
        return Util.navigate(page.url_fragment);
      }
    };
    $scope.$on('signedPetition', function(event, signature) {
      console.log('petition signed');
      PetitionFactory.signature = signature;
      return $scope.change_page();
    });
    ...
    $scope.$on('skipDelivery', function() {
      PetitionServices.get_more_petitions().then(function(petitions) {
        return console.log("got some other actions");
      });
      return $scope.change_page();
    });
    ...
    $scope.client_image_url = function() {
      return $scope.petition.client.image_large;
    };
    if (signature) {
...
(function() {
  ...
  this.SignatureController = function($scope, PetitionServices, $http, Util, $rootScope, $timeout) {
    var remove_errors;
    ...
    $scope.sign_with_facebook = function(auth) {
      ...
      return PetitionServices.sign_with_facebook($scope.auth, $scope.petition.petition_id, $scope.signature).success(function(response) {
        var fb_message_obj, result, signature;
        if (response.statusCode === 200) {
          console.log("signature complete; trying to Share via FB");
          $scope.loading.show_spinner = false;
          ...
          if (scope.petition.image_square_url) {
            $.extend(true, fb_message_obj, {
              picture: $scope.petition.image_square_url
            });
          } else {
            $.extend(true, fb_message_obj, {
              picture: 'http://snaptivist.s3.amazonaws.com/assets/logo_120x118.png'
    ...
    $scope.get_number_of_signatures = function() {
      return $scope.petition.signature_count || 0;
    };
    ...
    remove_errors = function() {
      ...
      return $scope.error_messages.sign_with_facebook = "";
    };
    $scope.clear_errors = function() {
      return $timeout(remove_errors, 4000);
    };
    $scope.form_styling = function() {
      if ($scope.form_submitted) {
        return "submitted";
      }
      return "";
    };
    return $scope.format_signature_location = function(signature) {
      var location;
      location = "";
      if (signature.city) {
      ...
      if (signature.city && signature.state) {
        return location += ", " + signature.state;
...
(function() {
  ...
  this.TweetController = function($scope, TweetServices, $http, $q, Util, $rootScope) {
    ...
    $scope.show_more_tweets_click = function() {
      ...
      return TweetServices.get_tweets($scope.petition.petition_id, $scope.comments.offset).then(save_tweets, error_tweets);
    };
...
(function() {
  ...
  this.app.directive("contenteditable", [
...
.provider( '$customtooltip', function () {
  ...
  this.$get = [ '$window', '$compile', '$timeout', '$parse', '$document', '$position', '$interpolate', function ( $window, $compile, $timeout, $parse, $document, $position, $interpolate ) {
    return function $customtooltip ( type, prefix, defaultTriggerShow ) {
      ...
      var directiveName = snake_case( 'popover' );
...
.directive( 'custompopover', [ '$compile', '$timeout', '$parse', '$window', '$customtooltip', function ( $compile, $timeout, $parse, $window, $customtooltip ) {
  return $customtooltip( 'custompopover', 'custompopover', 'click' );
}]);
(function() {
...
(function() {
  ...
  this.app.factory("PetitionFactory", function() {
    return {
      signature: {}
    };
  });
