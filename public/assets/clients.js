...
(function() {
  ...
  this.PetitionSetupController = function($scope, $route, $rootScope, $location, fileReader, layouts) {
    var lastRoute;
    window.scope = $scope;
    $scope.is_admin = true;
    ...
    $scope.next_step_clicked = function() {
    ...
    return PetitionSetupController.$inject = ['$scope', '$route', '$rootScope', '$location', 'fileReader', 'layouts'];
  };
